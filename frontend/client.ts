 ...
 */
export class Client {
    public readonly netcheck: netcheck.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.netcheck = new netcheck.ServiceClient(base)
    }
 ...
 */
import { info as api_netcheck_info_info } from "~backend/netcheck/info";

export namespace netcheck {
    ...
    export class ServiceClient {
         ...
         */
        public async info(): Promise<ResponseType<typeof api_netcheck_info_info>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/info`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_netcheck_info_info>
        }
    }
}
