...
```bash
git remote add encore encore://global-netcheck-dashboard-i8gi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/global-netcheck-dashboard-i8gi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/global-netcheck-dashboard-i8gi/settings/integrations/github)
